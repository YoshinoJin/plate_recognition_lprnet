...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="/home/zj/plate_detection_recognization/code_plate_detection_recognization/datasets/lpr/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="/home/zj/plate_detection_recognization/code_plate_detection_recognization/datasets/lpr/val", help='the test images path')
    ...
    parser.add_argument('--save_folder', default=r'runs/lpr/exp',
